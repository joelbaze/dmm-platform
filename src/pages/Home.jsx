            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl font-serif font-bold text-brand-navy mb-6">Why J-DMM?</h2>
                            <p className="text-lg text-brand-slate mb-6 leading-relaxed">
                                The Jesus Disciple Making Movement (J-DMM) is not just a program; it's a return to the biblical principles of multiplication. It focuses on obedience-based discipleship, where ordinary people are equipped to discover God's word and share it immediately.
                            </p>
